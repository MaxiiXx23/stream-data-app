  ...
  async function signIn() {
    try {
      ...
      const REDIRECT_URI = makeRedirectUri({
        scheme: "stream.data",
        path: "https://auth.expo.io/@maxiixx23/streamData",
        useProxy: true
      });
      ...
      if (authResponse.type === "success" && authResponse.params.error !== "access_denied") {
        ...
        // verify if startAsync authResponse.params.state differs from STATE
        // if true, do the following:
        ...
        const { id, email, display_name, profile_image_url }: User = userResponse.data.data[0];
